...
function Snake(start, brain){
    ...
    this.rayMagnitude = function(i){
        return map(this.hitmap[i], 1, CANVAS_DIMENSION_SNAKE/RESOLUTION-2, 1, 0);
    }
    ...
    this.hitsTheWall = function(i, j){
        return i >= CANVAS_DIMENSION_SNAKE/RESOLUTION-1 || i == 0 || j >= CANVAS_DIMENSION_SNAKE/RESOLUTION-1 || j == 0;
    }
