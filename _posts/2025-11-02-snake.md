...
date: 2025-11-02 23:20:16
description: An old academic project developed during my M.Sc. studies, exploring the use of neuroevolution to train an artificial neural network for the classic Snake game.
...
It implements a *Snake Game* controlled by an artificial neural network trained via **neuroevolution** —  
...
$$
f(\text{a}, \text{s}_c, \text{s}_f)
= e^{\text{a}} + 0.05 \cdot \text{s}_c - 0.1 \cdot \text{s}_f
$$
